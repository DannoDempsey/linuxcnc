...
class  GCodeGraphics(Lcnc_3dGraphics, _HalWidgetBase):
    ...
    def _hal_init(self):
        ...
        # Problematic, complaining about syntax
        #STATUS.connect('gcode-line-selected', lambda w, 1: self.highlight_graphics(1))
    ...
    # came from an external source - we only send it out if someone
    # clicked on us
